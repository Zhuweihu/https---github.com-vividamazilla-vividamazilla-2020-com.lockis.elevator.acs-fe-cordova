<template>
  <div>
      ...
      >
        ...
        <div class="choose">
          ...
          <div class="item">
            ...
            <div>
              <input type="text" v-model="sn" @blur="change" />
            </div>
          </div>
          <div class="item">
            <div>
            ...
            <div>
              <input type="text" v-model="macAddress" @blur="change" />
            </div>
          </div>
          <div class="item">
            <div>
            ...
            <div>
              <input type="text" v-model="key" @blur="change" />
            </div>
          </div>
          <div class="item">
            <div>
              <span>Validity period(from)</span>
            </div>
            <div>
              <el-date-picker
                v-model="dateStart"
          ...
          <div class="item">
            ...
            <div>
              <input type="text" v-model="password" @blur="change" />
            </div>
          </div>
          <div class="item">
            <div>
            ...
            <div>
              <el-radio v-model="isAll" label="1" class="radio" @change="change"
                >yes</el-radio
              >
              <el-radio v-model="isAll" label="0" class="radio" @change="change"
                >no</el-radio
              >
            </div>
          </div>
    ...
    >
      ...
      <button style="background-color:#f46c6c" @click="back">Back</button>
...
export default {
  ...
  methods: {
    ...
    click1(index){
      this.buttonList_[index+this.buttonList_.length].isSelect= !this.buttonList_[index+this.buttonList_.length].isSelect
    },
    next() {
      this.List = {
        buttonList: [],
      ...
      var buttonList = JSON.stringify(this.List.buttonList).replace("[","").replace("]","")
      ...
      this.QRCodeList = {
        [randomnumber]:{
          [real_extate]:{
            [building_setting]:{
              [elevator]:[
                buttonList,this.sn,this.macAddress,this.key,dateStart,dateEnd
              ]
            }
          }
        }
