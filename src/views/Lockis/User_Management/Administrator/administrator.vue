  ...
  <div class="elysExpense">
    ...
    >
      <div>
        ...
        <div>
          <el-dialog
            :title="isNew ? 'Create Administrator' : 'Change Administrator'"
  ...
  methods: {
    ...
    confirm() {
      ...
      if (this.form.reference != "" && this.form.reference != undefined) {
        axios.put("http://localhost:3004/administrator/"+this.form.id,this.form).then(res =>{
          this.search()
        }).catch(err =>{
        ...
        axios
          .post("http://localhost:3004/administrator", this.form)
          .then(res => {
            this.search()
          })
          .catch(err => {});
    ...
    search() {
      ...
      // axios
      //   .get("http://localhost:3004/administrator")
      //   .then(response => {
