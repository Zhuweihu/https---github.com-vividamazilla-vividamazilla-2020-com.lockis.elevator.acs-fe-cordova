  ...
  <div class="elysExpense">
    ...
    >
      <div>
        ...
        <div>
          <el-dialog
            :title="isNew ? 'Create Supplier Personnel' : 'Change Supplier Personnel'"
...
export default {
  ...
  methods: {
    ...
    confirm() {
      ...
      if (this.form.reference != "" && this.form.reference != undefined) {
        axios.put("http://localhost:3004/supplierpersonnel/"+this.form.id,this.form).then(res =>{
          this.search()
        }).catch(err =>{
        ...
        this.form.reference = "1111-aaaa-bbb"+this.tableData.length+1
        axios
          .post("http://localhost:3004/supplierpersonnel", this.form)
          .then(res => {
            this.search()
          })
          .catch(err => {});
    ...
    modify(res) {
      ...
      this.form.jurisdiction = res.jurisdiction;
    ...
    search() {
      ...
      // this.$api.get("/administrator.json", null, r => {
      ...
      // axios
      //   .get("http://localhost:3004/supplierpersonnel")
      //   .then(response => {
